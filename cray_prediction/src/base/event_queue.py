...
class EventQueue(object):
    ...
    def add_event(self, event):
        #All kinds of events get added here. Be it start or Terminated.
        #print "Event from event_queue.py\t",event
        #print self._events_heap
    ...
    def events(self):
        ...
        #for (timestamp,event) in self._events_heap:
            #print event
